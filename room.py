...
class Roombooking:
    def __init__(self, root):
        ...
        # ================logo==============
        img2 = Image.open(r"D:\Hotel\saga.png")
        ...
        conn = mysql.connector.connect(host="localhost", username="root", password="Sagar@1512",database="hoteldatabase")
        ...
        conn = mysql.connector.connect(host="localhost", port="3306", username="root", password="Sagar@1512",database="hoteldatabase")
        my_cursor = conn.cursor()
        ...
        # ================Rightside image==============
        img3 = Image.open(r"D:\Hotel\Hotel2.jpg")
        ...
        self.room_table=ttk.Treeview(details_table,column=("Contact","Check-in","Check-Out","Room Type","Room No","Meal","NoOfDays"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
